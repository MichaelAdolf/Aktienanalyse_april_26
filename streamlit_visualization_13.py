...
RULE_REASON_MAP = {
    ...
    "macd_hist_neg": {
        "label": "Negatives Momentum (MACD)",
        "text": "Das MACD‑Histogramm ist negativ, was auf anhaltenden Abwärtsdruck hinweist."
    },
    "hist_nonneg": {
        "label": "Momentum verbessert sich (MACD)",
        "text": "Das MACD‑Histogramm ist nicht mehr negativ – ein erstes Stabilisierungssignal."
    },
    "macd_cross_up": {
        "label": "MACD‑Kaufsignal",
        "text": "Der MACD hat ein bullisches Crossover gebildet – ein klassisches Trendwendesignal."
    },
    "validated": {
        "label": "Setup bestätigt",
        "text": "Das initiale Setup wurde innerhalb des Zeitfensters durch weitere Signale bestätigt."
    },
    "enter": {
        "label": "Einstiegsphase gestartet",
        "text": "Alle Kernbedingungen für ein mögliches Long‑Setup sind erfüllt."
    },
    "meta_suppressed": {
        "label": "Meta‑Modell warnt",
        "text": "Das Meta‑Modell schätzt die Erfolgswahrscheinlichkeit als zu gering ein."
    },
}
